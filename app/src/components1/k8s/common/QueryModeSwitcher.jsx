    ...
    if (currentQLEditor === 'build') {
      ...
      return (
        <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 'var(--ds-space-2)', marginTop: 'var(--ds-space-4)' }}>
          ...
          <CodeMirror
            style={{
              border: `1px solid ${ds.gray[700]}`,
              background: 'var(--ds-brand-700)',
              overflow: 'auto',
              padding: '0px',
              borderRadius: 'var(--ds-radius-md)',
              width: '100%',
              height: ds.space.mul(0, 100),
            }}
            value={query}
            width={'100%'}
            height='auto'
      ...
      return (
        <>
          <Box
            display='flex'
            sx={{
              alignItems: !helperTextForLLM ? 'center' : '',
              gap: 'var(--ds-space-3)',
              mb: 'var(--ds-space-2)',
              mt: 'var(--ds-space-4)',
              width: '96%',
          ...
          >
            <Box display='flex' flexDirection='column' gap='var(--ds-space-1)' sx={{ width: '100%' }}>
              <SummaryBlock
                hideTitle
                sx={{
                  display: 'flex',
              ...
              >
                <Box sx={{ width: '100%' }}>
                  <Input
                    ...
                    onChange={(next) => setGenerateQuestionText(next)}
                    onKeyDown={(e) => {
                  ...
                  />
                  {helperTextForLLM && (
                    <Typography sx={{ color: 'var(--ds-red-600)', fontSize: 'var(--ds-text-body-lg)' }}>{helperTextForLLM}</Typography>
                  )}
                </Box>
                <Box>
                  <DsButton
                    ...
                    icon={<SafeIcon src={ArrowRightWhiteIcon} alt='Generate' width={18} height={18} />}
          ...
          >
            {isLoadingGenerateQuestionText ? (
              <Skeleton shape='rect' height={180} width='99%' />
            ) : (
              <CodeMirror
                style={{
                  border: `1px solid ${ds.gray[700]}`,
                  ...
                  width: '100%',
                  background: 'var(--ds-brand-700)',
                  minHeight: ds.space.mul(0, 90),
                  maxHeight: ds.space.mul(0, 130),
                }}
                value={query}
                width={'100%'}
                height='auto'
