...
import { FormControlLabel, Box, Typography, Grid, Switch, IconButton } from '@mui/material';
  ...
  const renderWebhookContent = (integrationName, response) => {
    ...
    return (
      <Grid container mt={2} mb={1} mr={1} sx={{ display: 'flex', flexDirection: 'column' }}>
        ...
        >
          <Typography
            sx={{ color: colors.text.greyDark, fontSize: 'var(--ds-text-body-lg)', wordBreak: 'break-all', lineHeight: 1.6, flex: 1 }}
            variant='body1'
        ...
        {integrationName === 'workflow_webhook' ? (
          ...
          >
            <Typography sx={{ fontSize: 'var(--ds-text-body)', color: colors.text.secondary, lineHeight: 1.6, textAlign: 'justify' }}>
      ...
      >
        {isAgentSource ? (
          <Box sx={{ minHeight: '200px', pt: 3, pb: 1 }}>
            <Typography variant='body2' sx={{ color: colors.text.secondaryDark, fontSize: 'var(--ds-text-body)', mb: 2 }}>
            ...
            {agentAccountProviders.map((acc) => (
              ...
              >
                ...
                {providerFields.map((provider) => (
                  ...
                  >
                    <Typography variant='body2' sx={{ fontSize: 'var(--ds-text-body)', color: colors.text.secondaryDark }}>
                      {provider.label}
                    </Typography>
                    <FormControlLabel
                      control={
          ...
          <>
            <Box sx={{ minHeight: '200px', pt: 3, pb: 1 }}>
              {isLoadingSchema ? (
                ...
                >
                  <Typography variant='body2' sx={{ color: colors.text.secondaryDark, fontSize: 'var(--ds-text-body)' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  ...
                  {config?.description && (
                    ...
                    >
                      ...
                      <Typography variant='body2' sx={{ fontSize: 'var(--ds-text-body)', color: colors.text.secondaryDark, lineHeight: 1.5 }}>
                        {config.description}
                      </Typography>
                    </Box>
                  )}
                  {Object.keys(config?.properties || {}).length > 0 ? (
                            ...
                            inputComponent = (
                              <Box key={`wrapper-${key}`} sx={{ mb: 0.5 }}>
                                ...
                                {!errorText && ag.message && (
                                  <Typography variant='body2' sx={{ mt: 0.5, fontSize: 'var(--ds-text-caption)', color: colors.text.secondaryDark }}>
                                    {ag.message}
                                  </Typography>
                                )}
                    ...
                    >
                      <Typography
                        variant='body1'
                        sx={{ color: colors.text.secondary, fontSize: 'var(--ds-text-body-lg)', fontWeight: 'var(--ds-font-weight-medium)' }}
                      >
                        Nothing to Configure
                      </Typography>
                      <Typography
                        variant='body2'
                        sx={{ color: colors.text.secondaryDark, fontSize: 'var(--ds-text-body)', mt: 1, textAlign: 'center' }}
                      >
                  ...
                  {rules.map((rule, ruleIdx) => (
                    ...
                    >
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1.5 }}>
                        <Typography
                          sx={{ fontSize: 'var(--ds-text-body)', fontWeight: 'var(--ds-font-weight-semibold)', color: colors.text.primary }}
                        >
                          Rule {ruleIdx + 1}
                        </Typography>
                        {rules.length > 1 && (
                      ...
                      {rule.match.map((cond, condIdx) => (
                        <Box key={condIdx}>
                          ...
                          <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'flex-end', mb: 1 }}>
                            ...
                            <Typography sx={{ fontSize: 'var(--ds-text-body-lg)', color: colors.text.secondary, pb: 1.25 }}>=</Typography>
                            <Box sx={{ flex: 1 }}>
                              <Input
